...
Feature: HTML student blocks in a course
  In order to have one or multiple student HTML blocks in a course
  As a teacher
  ...
  Scenario: Adding HTML block in a course
    Given the following "users" exist:
      ...
      | teacher1 | Terry1    | Teacher1 | teacher@example.com  | academic |
