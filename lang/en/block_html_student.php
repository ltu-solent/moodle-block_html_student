...
/**
 * Strings for component 'block_html_student', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['html_student:addinstance'] = 'Add a new HTML student block';
$string['html_student:myaddinstance'] = 'Add a new HTML student block to Dashboard';
$string['leaveblanktohide'] = 'leave blank to hide the title';
$string['newhtmlstudentblock'] = '(new HTML student block)';
$string['pluginname'] = 'HTML student';
