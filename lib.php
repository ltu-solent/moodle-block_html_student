 ...
 */
function block_html_student_pluginfile($course, $birecordorcm, $context, $filearea, $args, $forcedownload, array $options = []) {
    global $DB, $CFG, $USER;
    ...
    $file = $fs->get_file($context->id, 'block_html_student', 'content', 0, $filepath, $filename);
...
function block_html_student_global_db_replace($search, $replace) {
    ...
    $instances = $DB->get_recordset('block_instances', ['blockname' => 'html_student']);
